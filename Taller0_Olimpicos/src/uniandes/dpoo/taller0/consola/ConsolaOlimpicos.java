...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pa�s de un atleta por el nombre");
	...
	private void ejecutarConsultarPaisAtleta()
	{
		...
		String Pais = calculadora.ConsultarPaisAtleta(nombreAtleta);
		System.out.println("El pais de " + nombreAtleta + " es " + Pais);
	}
	/**
